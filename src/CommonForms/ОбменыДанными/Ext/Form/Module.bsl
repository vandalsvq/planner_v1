...
Процедура ЗагрузитьПравилаСинхронизацииДанных(Команда)
	...
	Если СведенияОПланеОбмена.ЭтоРИБ Тогда
...
Функция СведенияОПланеОбмена(Знач УзелИнформационнойБазы)
	...
	Результат = Новый Структура("ИмяПланаОбмена,ЭтоРИБ");
	Результат.ИмяПланаОбмена = ОбменДаннымиПовтИсп.ПолучитьИмяПланаОбмена(УзелИнформационнойБазы);
	Результат.ЭтоРИБ = ОбменДаннымиПовтИсп.ЭтоПланОбменаРаспределеннойИнформационнойБазы(Результат.ИмяПланаОбмена);
	Возврат Результат;
