...
Функция ДляВсехОрганизацийНазначеныОтветственные(Отбор = Неопределено, Сообщение = "") Экспорт
	...
	Если КоличествоОшибок > 0 Тогда
		...
		СтрокаОрганзаций = СтроковыеФункцииКлиентСервер.СтрокаИзМассиваПодстрок(СписокОрганизаций, ", ");
		Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(СтрокаСообщения, СтрокаОрганзаций);
