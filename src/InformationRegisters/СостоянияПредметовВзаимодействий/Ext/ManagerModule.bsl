...
//
// Параметры:
//  Предемет  - Ссылка на предмет взаимодействий, Неопределено - предмет, для которого удаляется запись.
...
//  ДатаПоследнегоВзаимодействия  - ДатаВремя - дата последенего взаимодействия по предмету
