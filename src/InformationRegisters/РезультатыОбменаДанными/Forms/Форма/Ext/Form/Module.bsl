...
Процедура ПоказыватьПроигнорированныеКонфликты(Команда)
	...
	ПоказыватьПроигнорированныеКонфликтыНаСервере(ПоказыватьПроигнорированныеКонфликты);
...
Процедура ПоказыватьПроигнорированныеНезаполненные(Команда)
	...
	ПоказыватьПроигнорированныеНезаполненныеНаСервере(Истина);
...
Процедура ПоказыватьПроигнорированныеНепринятые(Команда)
	...
	ПоказыватьПроигнорированныеНепринятыеНаСервере(Истина);
...
Процедура ПоказыватьПроигнорированныеНепроведенные(Команда)
	...
	ПоказыватьПроигнорированныеНепроведенныеНаСервере(Истина);
...
Функция КоличествоКоллизий()
	...
	Возврат ОбменДаннымиСервер.КоличествоПроблемВерсионирования(
		УзлыОбмена, Истина, ПоказыватьПроигнорированныеКонфликты, Период, СтрокаПоиска
	);
