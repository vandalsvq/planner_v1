...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РежимОтладки = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить(
		"ОбновлениеВерсииИБ", "РежимОтладки", Ложь);
...
Процедура ПриОткрытии(Отказ)
	...
	Если Найти(ПараметрЗапуска, "ЗапуститьОбновлениеИнформационнойБазы") > 0 Тогда
...
Процедура Дополнительно(Команда)
	ОткрытьФорму(ПутьКФормам + ".УправлениеОтложеннымОбновлением",, ЭтотОбъект);
КонецПроцедуры
...
Процедура ЗаписатьВсеНаСервере()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(
		"ОбновлениеВерсииИБ", "РежимОтладки", РежимОтладки);
	...
	Если ИмитироватьОшибкуПриОбновлении Тогда
		ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("ОбновлениеИБ",
...
Процедура ПерезапуститьПрограммуЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если НЕ ЗапуститьОбновлениеИнформационнойБазы
	 ИЛИ Найти(ПараметрЗапуска, "ЗапуститьОбновлениеИнформационнойБазы") > 0 Тогда
