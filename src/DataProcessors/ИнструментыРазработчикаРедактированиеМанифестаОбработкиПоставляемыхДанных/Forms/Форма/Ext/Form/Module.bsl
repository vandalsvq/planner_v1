...
Функция ПолучитьМанифест(Знач Манифест)
	...
	ВерсияФормата = "";
	Если Корень.ИмяЭлемента <> "SuppliedDataProcessor" Или 
		(Корень.URIПространстваИмен <> "http://www.1c.ru/SaaS/SuppliedData"
...
Функция ТекущиеДанныеДляФормы()
	...
	Возврат Новый Структура("Код, Наименование, Задержка, ЗапретУведомления, Характеристики",
		Элемент.Код, Элемент.Наименование,
		Элемент.Задержка,
		Элемент.ЗапретУведомления,
