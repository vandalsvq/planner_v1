...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КраткоеОписание = МенеджерПланаОбмена.КраткаяИнформацияПоОбмену();
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ОбменДаннымиXDTO")
		И ОбщегоНазначения.ОбщийМодуль("ОбменДаннымиXDTOПовтИсп").ЭтоПланОбменаXDTO(Объект.ИмяПланаОбмена) Тогда
		Заголовок = СинонимПланаОбмена;
	Иначе
